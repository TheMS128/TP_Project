...
public class CourseContentControllerTests
{
    ...
    public void Setup()
    {
        ...
        _controller =
            new CourseContentController(_mockContext.Object, _mockUserManager.Object, _mockEnvironment.Object);
    ...
    public async Task CreateQuestion_Valid_Saves()
    {
        ...
        questionsMock.Verify(m => m.Add(It.Is<Question>(q => q.Text == "2+2" && q.AnswerOptions.Count == 2)),
            Times.Once);
        _mockContext.Verify(c => c.SaveChangesAsync(default), Times.Once);
    }
